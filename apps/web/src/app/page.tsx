...
const capabilities = [
  ...
  },
  {
    ...
    title: "Conversations",
    description: "Enquiries and follow-ups organised around the people involved.",
  },
  {
    icon: Layers3,
    title: "Opportunities",
    description: "A practical pipeline that connects conversations to next actions.",
  },
  {
    icon: Building2,
    title: "Properties",
    description: "Property context available where a response or decision is made.",
  },
  {
    icon: BookOpen,
    title: "Agency brain",
    description: "Organisation knowledge used to ground drafts and recommendations.",
  },
  {
    icon: ShieldCheck,
    title: "Operations",
    description: "Role-protected diagnostics, usage, integrations, and incident visibility.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-hero text-neutral-800">
      <header className="sticky top-0 z-50 border-b border-neutral-200 bg-white/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2" aria-label="Clippy home">
          ...
          >
            ...
            <Link href="#capabilities" className="transition-colors hover:text-primary">
              Product
            </Link>
        ...
        <section className="px-6 pb-24 pt-24 md:pb-32 md:pt-32">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-3xl text-lg leading-8 text-neutral-600 md:text-xl">
              ...
              knowledge into one workspace—so agents can respond with context and
              principals can see what needs attention.
            </p>
        ...
        <section id="workflow" className="border-y bg-white px-6 py-24">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-3">
              {workflow.map((step) => (
                <article key={step.number} className="rounded-2xl border bg-neutral-50 p-7">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-md leading-7 text-neutral-600">
                Clippy is being built as a hybrid layer around the systems an agency
                already uses, with new modules enabled only when their live data
                source and controls are ready.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-neutral-300">
                We label empty and unconfigured states, protect administration on
                the server, keep automation secrets out of the browser, and avoid
                presenting sample metrics as customer results.
              </p>
            </div>
            <div className="rounded-2xl border border-white/15 bg-white/5 p-7">
              ...
              <p className="mt-4 leading-7 text-neutral-300">
                Formal certifications, guaranteed response times, customer counts,
                and measured business outcomes will appear here only when evidence
        ...
        <section className="px-6 py-24 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-neutral-600">
              Start with the work Clippy can support today, then connect additional
              channels and controls as your workspace grows.
            </p>
            <Link
              href="/signup"
