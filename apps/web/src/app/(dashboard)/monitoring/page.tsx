...
export default function MonitoringPage() {
  const [checks, setChecks] = useState<HealthCheck[]>([
    ...
    {
      name: "API Health",
      url: "https://useclippy.com/api/health",
      status: "checking",
      lastCheck: "",
      latency: 0,
    },
    {
      ...
      url: "https://useclippy.com/api/subscription/plans",
      status: "checking",
      lastCheck: "",
      latency: 0,
    },
  ...
  const uptimePct =
    uptime.total > 0 ? Math.round((uptime.up / uptime.total) * 100) : 100;
      ...
      <div className="rounded-xl border border-border bg-card p-6">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-foreground font-medium">Ollama Cloud</span>
          </div>
          <div className="flex justify-between">
